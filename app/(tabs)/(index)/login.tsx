...
import { TouchableOpacity, Text, View, TextInput, ClearView, ScrollView } from '@/components/Themed';
...
export default function LoginScreen() {
    ...
    const { iconColor, grayBackground, grayBorder, greenText, buttonGreen } = useTheme();
