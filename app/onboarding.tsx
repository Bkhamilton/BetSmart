...
export default function OnboardingScreen() {
  ...
  return (
    <>
      ...
      <ScrollView 
        style={{ flex: 1 }} 
        contentContainerStyle={styles.bookiesScrollContent}
        showsVerticalScrollIndicator={false}
      >
        <View style={styles.bookiesContainer}>
          <Text style={styles.bookiesSubtitle}>Select the sportsbooks you plan to use</Text>
