...
// Function to insert a full team
export const insertFullTeam = async (db, id, teamName, abbreviation, leagueId, logoUrl) => {
    try {
        await db.runAsync('INSERT INTO Teams (id, teamName, abbreviation, leagueId, logoUrl) VALUES (?, ?, ?, ?, ?)', [id, teamName, abbreviation, leagueId, logoUrl]);
    } catch (error) {
        console.error('Error inserting team:', error);
        throw error;
    }
...
export const clearTeams = async (db) => {
    try {
