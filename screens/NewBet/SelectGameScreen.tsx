...
export default function SelectGameScreen() {
    ...
    type LeagueData = {
        league: string;
        data: {
            games: any[]; // Replace 'any' with your actual game type if available
        };
    };
    ...
    const {
        ...
        selectLeagueModal,
        leagueSelected,
        allSportsData: allSportsDataRaw,
    ...
    const allSportsData = allSportsDataRaw as LeagueData[];
    const curLeagueData = allSportsData?.find((sportData: LeagueData) => sportData.league === league?.leagueName);
    const curLeagueGames = curLeagueData ? curLeagueData.data : { games: [] };
