...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PropOddsApi.FantasySnapshot();
  });
  ...
  describe('FantasySnapshot', function() {
    it('should create an instance of FantasySnapshot', function() {
      // uncomment below and update the code to test FantasySnapshot
      //var instance = new PropOddsApi.FantasySnapshot();
      //expect(instance).to.be.a(PropOddsApi.FantasySnapshot);
    });
