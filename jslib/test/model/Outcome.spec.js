...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PropOddsApi.Outcome();
  });
  ...
  describe('Outcome', function() {
    it('should create an instance of Outcome', function() {
      ...
      //var instance = new PropOddsApi.Outcome();
      //expect(instance).to.be.a(PropOddsApi.Outcome);
    });
    ...
    it('should have the property odds (base name: "odds")', function() {
      // uncomment below and update the code to test the property odds
      //var instance = new PropOddsApi.Outcome();
      //expect(instance).to.be();
    });
