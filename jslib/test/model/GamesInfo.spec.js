...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PropOddsApi.GamesInfo();
  });
  ...
  describe('GamesInfo', function() {
    it('should create an instance of GamesInfo', function() {
      // uncomment below and update the code to test GamesInfo
      //var instance = new PropOddsApi.GamesInfo();
      //expect(instance).to.be.a(PropOddsApi.GamesInfo);
    });
