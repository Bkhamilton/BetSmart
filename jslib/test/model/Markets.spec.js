...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PropOddsApi.Markets();
  });
  ...
  describe('Markets', function() {
    it('should create an instance of Markets', function() {
      // uncomment below and update the code to test Markets
      //var instance = new PropOddsApi.Markets();
      //expect(instance).to.be.a(PropOddsApi.Markets);
    });
