...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PropOddsApi.GameInfo();
  });
  ...
  describe('GameInfo', function() {
    it('should create an instance of GameInfo', function() {
      // uncomment below and update the code to test GameInfo
      //var instance = new PropOddsApi.GameInfo();
      //expect(instance).to.be.a(PropOddsApi.GameInfo);
    });
