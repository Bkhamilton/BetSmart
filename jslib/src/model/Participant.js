...
class Participant {
    ...
    constructor(participantId, name) { 
        ...
        Participant.initialize(this, participantId, name);
    }
     ...
     */
    static initialize(obj, participantId, name) { 
...
Participant.RequiredProperties = ["participant_id", "name"];

/**
 * @member {Number} participant_id
 */
Participant.prototype['participant_id'] = undefined;
